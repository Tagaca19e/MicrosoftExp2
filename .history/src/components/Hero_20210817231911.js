          ...
          <div className="herp space-y-5">
            ...
            <div className="short-description">
              <p className="tracking-wide leading-relaxed">
                ...
                student studying Computer Science at California State
                University. My interests include software engineering, web
                development, and solving data structure problems. ⚒️{" "}
              </p>
            </div>
          </div>
        </div>
